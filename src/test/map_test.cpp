...
TEST(Map, iterator) {
  ...
  typename map<std::string, int>::iterator it = our_dict.begin();
...
TEST(Map, test_merge) {
  ...
  map<std::string, int> dict_to_merge = {
      {"Danil", 2018},
      {"Dmitry", 2018},
  };
  std::map<std::string, int> orig_dict = {
